...
```{r}
hist(stepsperday$steps, xlab = "total number of steps taken each day", main = "Histogram of the total number of steps taken each day")
```
...
To fill in all the missing values in the dataset the mean for that day will be used to replace the missing value.
